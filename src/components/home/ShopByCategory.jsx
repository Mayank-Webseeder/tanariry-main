...
function LargeCategoryCard({ title, desc, image, onClick }) {
  return (
    <div
      onClick={onClick}
      className="group relative overflow-hidden aspect-[4/5] rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 cursor-pointer"
    >
      <Image
        src={image}
        alt={title}
